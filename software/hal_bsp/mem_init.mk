...
# Memory: scratchpad
MEM_1 := platformniossdram_scratchpad
$(MEM_1)_NAME := scratchpad
...
$(MEM_1)_END := 0x0404ffff
$(MEM_1)_SPAN := 0x00010000
$(MEM_1)_HIERARCHICAL_PATH := scratchpad
$(MEM_1)_WIDTH := 32
...
.PHONY: scratchpad
scratchpad: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
