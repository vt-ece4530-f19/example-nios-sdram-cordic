...
module platformniossdram_mm_interconnect_0 (
		...
		output wire [13:0] scratchpad_s1_address,                          //                            scratchpad_s1.address
	...
	wire    [9:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> timer_1_s1_agent:cp_channel
	...
	wire   [31:0] scratchpad_s1_agent_m0_readdata;                                                    // scratchpad_s1_translator:uav_readdata -> scratchpad_s1_agent:m0_readdata
	wire          scratchpad_s1_agent_m0_waitrequest;                                                 // scratchpad_s1_translator:uav_waitrequest -> scratchpad_s1_agent:m0_waitrequest
	wire          scratchpad_s1_agent_m0_debugaccess;                                                 // scratchpad_s1_agent:m0_debugaccess -> scratchpad_s1_translator:uav_debugaccess
	wire   [26:0] scratchpad_s1_agent_m0_address;                                                     // scratchpad_s1_agent:m0_address -> scratchpad_s1_translator:uav_address
	wire    [3:0] scratchpad_s1_agent_m0_byteenable;                                                  // scratchpad_s1_agent:m0_byteenable -> scratchpad_s1_translator:uav_byteenable
	wire          scratchpad_s1_agent_m0_read;                                                        // scratchpad_s1_agent:m0_read -> scratchpad_s1_translator:uav_read
	wire          scratchpad_s1_agent_m0_readdatavalid;                                               // scratchpad_s1_translator:uav_readdatavalid -> scratchpad_s1_agent:m0_readdatavalid
	wire          scratchpad_s1_agent_m0_lock;                                                        // scratchpad_s1_agent:m0_lock -> scratchpad_s1_translator:uav_lock
	wire   [31:0] scratchpad_s1_agent_m0_writedata;                                                   // scratchpad_s1_agent:m0_writedata -> scratchpad_s1_translator:uav_writedata
	wire          scratchpad_s1_agent_m0_write;                                                       // scratchpad_s1_agent:m0_write -> scratchpad_s1_translator:uav_write
	wire    [2:0] scratchpad_s1_agent_m0_burstcount;                                                  // scratchpad_s1_agent:m0_burstcount -> scratchpad_s1_translator:uav_burstcount
	wire          scratchpad_s1_agent_rf_source_valid;                                                // scratchpad_s1_agent:rf_source_valid -> scratchpad_s1_agent_rsp_fifo:in_valid
	wire  [105:0] scratchpad_s1_agent_rf_source_data;                                                 // scratchpad_s1_agent:rf_source_data -> scratchpad_s1_agent_rsp_fifo:in_data
	wire          scratchpad_s1_agent_rf_source_ready;                                                // scratchpad_s1_agent_rsp_fifo:in_ready -> scratchpad_s1_agent:rf_source_ready
	wire          scratchpad_s1_agent_rf_source_startofpacket;                                        // scratchpad_s1_agent:rf_source_startofpacket -> scratchpad_s1_agent_rsp_fifo:in_startofpacket
	wire          scratchpad_s1_agent_rf_source_endofpacket;                                          // scratchpad_s1_agent:rf_source_endofpacket -> scratchpad_s1_agent_rsp_fifo:in_endofpacket
	wire          scratchpad_s1_agent_rsp_fifo_out_valid;                                             // scratchpad_s1_agent_rsp_fifo:out_valid -> scratchpad_s1_agent:rf_sink_valid
	wire  [105:0] scratchpad_s1_agent_rsp_fifo_out_data;                                              // scratchpad_s1_agent_rsp_fifo:out_data -> scratchpad_s1_agent:rf_sink_data
	wire          scratchpad_s1_agent_rsp_fifo_out_ready;                                             // scratchpad_s1_agent:rf_sink_ready -> scratchpad_s1_agent_rsp_fifo:out_ready
	wire          scratchpad_s1_agent_rsp_fifo_out_startofpacket;                                     // scratchpad_s1_agent_rsp_fifo:out_startofpacket -> scratchpad_s1_agent:rf_sink_startofpacket
	wire          scratchpad_s1_agent_rsp_fifo_out_endofpacket;                                       // scratchpad_s1_agent_rsp_fifo:out_endofpacket -> scratchpad_s1_agent:rf_sink_endofpacket
	wire          cmd_mux_009_src_valid;                                                              // cmd_mux_009:src_valid -> scratchpad_s1_agent:cp_valid
	wire  [104:0] cmd_mux_009_src_data;                                                               // cmd_mux_009:src_data -> scratchpad_s1_agent:cp_data
	wire          cmd_mux_009_src_ready;                                                              // scratchpad_s1_agent:cp_ready -> cmd_mux_009:src_ready
	wire    [9:0] cmd_mux_009_src_channel;                                                            // cmd_mux_009:src_channel -> scratchpad_s1_agent:cp_channel
	wire          cmd_mux_009_src_startofpacket;                                                      // cmd_mux_009:src_startofpacket -> scratchpad_s1_agent:cp_startofpacket
	wire          cmd_mux_009_src_endofpacket;                                                        // cmd_mux_009:src_endofpacket -> scratchpad_s1_agent:cp_endofpacket
	...
	wire          scratchpad_s1_agent_rp_valid;                                                       // scratchpad_s1_agent:rp_valid -> router_011:sink_valid
	wire  [104:0] scratchpad_s1_agent_rp_data;                                                        // scratchpad_s1_agent:rp_data -> router_011:sink_data
	wire          scratchpad_s1_agent_rp_ready;                                                       // router_011:sink_ready -> scratchpad_s1_agent:rp_ready
	wire          scratchpad_s1_agent_rp_startofpacket;                                               // scratchpad_s1_agent:rp_startofpacket -> router_011:sink_startofpacket
	wire          scratchpad_s1_agent_rp_endofpacket;                                                 // scratchpad_s1_agent:rp_endofpacket -> router_011:sink_endofpacket
	...
	wire          scratchpad_s1_agent_rdata_fifo_src_valid;                                           // scratchpad_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_009:in_0_valid
	wire   [33:0] scratchpad_s1_agent_rdata_fifo_src_data;                                            // scratchpad_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_009:in_0_data
	wire          scratchpad_s1_agent_rdata_fifo_src_ready;                                           // avalon_st_adapter_009:in_0_ready -> scratchpad_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_009_out_0_valid;                                                  // avalon_st_adapter_009:out_0_valid -> scratchpad_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_009_out_0_data;                                                   // avalon_st_adapter_009:out_0_data -> scratchpad_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_009_out_0_ready;                                                  // scratchpad_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_009:out_0_ready
	wire    [0:0] avalon_st_adapter_009_out_0_error;                                                  // avalon_st_adapter_009:out_0_error -> scratchpad_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (pll_0_outclk0_clk),                              //                      clk.clk
		.reset                  (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (scratchpad_s1_agent_m0_address),                 // avalon_universal_slave_0.address
		.uav_burstcount         (scratchpad_s1_agent_m0_burstcount),              //                         .burstcount
		.uav_read               (scratchpad_s1_agent_m0_read),                    //                         .read
		.uav_write              (scratchpad_s1_agent_m0_write),                   //                         .write
		.uav_waitrequest        (scratchpad_s1_agent_m0_waitrequest),             //                         .waitrequest
		.uav_readdatavalid      (scratchpad_s1_agent_m0_readdatavalid),           //                         .readdatavalid
		.uav_byteenable         (scratchpad_s1_agent_m0_byteenable),              //                         .byteenable
		.uav_readdata           (scratchpad_s1_agent_m0_readdata),                //                         .readdata
		.uav_writedata          (scratchpad_s1_agent_m0_writedata),               //                         .writedata
		.uav_lock               (scratchpad_s1_agent_m0_lock),                    //                         .lock
		.uav_debugaccess        (scratchpad_s1_agent_m0_debugaccess),             //                         .debugaccess
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (pll_0_outclk0_clk),                              //             clk.clk
		.reset                   (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (scratchpad_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (scratchpad_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (scratchpad_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (scratchpad_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (scratchpad_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (scratchpad_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (scratchpad_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (scratchpad_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (scratchpad_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (scratchpad_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (scratchpad_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (scratchpad_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (scratchpad_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (scratchpad_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (scratchpad_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (scratchpad_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (scratchpad_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (scratchpad_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (scratchpad_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (scratchpad_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (scratchpad_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (scratchpad_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (scratchpad_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (scratchpad_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (scratchpad_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (scratchpad_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_009_out_0_ready),              // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_009_out_0_valid),              //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_009_out_0_data),               //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_009_out_0_error),              //                .error
		.rdata_fifo_src_ready    (scratchpad_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (scratchpad_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (scratchpad_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                          //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                            //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) scratchpad_s1_agent_rsp_fifo (
		.clk               (pll_0_outclk0_clk),                              //       clk.clk
		.reset             (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (scratchpad_s1_agent_rf_source_data),             //        in.data
		.in_valid          (scratchpad_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (scratchpad_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (scratchpad_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (scratchpad_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (scratchpad_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (scratchpad_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (scratchpad_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (scratchpad_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (scratchpad_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                          // (terminated)
		.csr_read          (1'b0),                                           // (terminated)
		.csr_write         (1'b0),                                           // (terminated)
		.csr_readdata      (),                                               // (terminated)
	...
	platformniossdram_mm_interconnect_0_router_002 router_011 (
		.sink_ready         (scratchpad_s1_agent_rp_ready),                   //      sink.ready
		.sink_valid         (scratchpad_s1_agent_rp_valid),                   //          .valid
		.sink_data          (scratchpad_s1_agent_rp_data),                    //          .data
		.sink_startofpacket (scratchpad_s1_agent_rp_startofpacket),           //          .startofpacket
		.sink_endofpacket   (scratchpad_s1_agent_rp_endofpacket),             //          .endofpacket
		.clk                (pll_0_outclk0_clk),                              //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	platformniossdram_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (pll_0_outclk0_clk),                              // in_clk_0.clk
		.in_rst_0_reset (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (scratchpad_s1_agent_rdata_fifo_src_data),        //     in_0.data
		.in_0_valid     (scratchpad_s1_agent_rdata_fifo_src_valid),       //         .valid
		.in_0_ready     (scratchpad_s1_agent_rdata_fifo_src_ready),       //         .ready
